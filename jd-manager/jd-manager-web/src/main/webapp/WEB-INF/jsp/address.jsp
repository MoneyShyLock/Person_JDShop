                        ...
                        <c:if test="${address.status==0}">
                            <li class="user-addresslist defaultAddr">
                                ...
                                <p class="new-tit new-p-re">
                                    <span class="new-txt">${user.username}</span>
                            ...
                            <form class="am-form am-form-horizontal" id="addressForm">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <input type="text" id="user-name" placeholder="${user.username}">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <input id="user-phone" placeholder="${user.phone}" type="email">
                                    </div>
                                </div>
                                <div class="am-form-group">
        ...
        <ul>
            ...
            <li class="person">
                ...
                <ul>
                    ...
                    <li class="active"><a href="address">地址管理</a></li>
