            ...
            <div class="user-info">
                ...
                <div class="user-infoPic">
                    ...
                    <div class="filePic" >
                        ...
                        <img name="headPic" class="am-circle am-img-thumbnail" src="${user.headPic}" alt=""/>
                    </div>
                    ...
                    <form class="am-form am-form-horizontal" id="personForm" method="post" action="modify">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="text" id="realname" VALUE="${user.realname}" name="realname">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content birth">
                                <div>
                                    <input readonly="readonly" id="idNumber" VALUE="${user.idNumber}" type="text"
                                           name="idNumber">
                                </div>
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="user-phone" VALUE="${user.phone}" type="tel" name="phone">
                        ...
                        <div class="info-btn">
                            ...
                            <input type="submit" class="am-btn am-btn-danger"
                                   style="background:url(../../images/body.jpg)" value="保存修改">
                        </div>
        ...
        <ul>
            ...
            <li class="person">
                ...
                <ul>
                    ...
                    <li><a href="jumpTo?name=safety">安全设置</a></li>
                    <li><a href="address">地址管理</a></li>
                    <li><a href="jumpTo?name=cardlist">快捷支付</a></li>
                </ul>
            </li>
            <li class="person">
                ...
                <ul>
                    ...
                    <li><a href="change.html">购物车　</a></li>
